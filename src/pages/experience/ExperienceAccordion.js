...
const boeing = {
    ...
    location: "Office 100%",
    description: "Developed a robust Grafana monitoring dashboard that enables effective visualization and analysis of system metrics. A key focus was on packaging persistent data into releases, ensuring streamlined deployment and integration. Additionally, I optimized C++/Clang RedHat compatibility testing by implementing Docker and parallel building, resulting in an impressive 6x reduction in testing time. Lastly, I authored comprehensive documentation encompassing introductory resources, facilitating a smooth onboarding process for new hires and ensuring their timely assimilation into the team."
};
...
const pepl = {
    ...
    logo_url: "https://pepl.engin.umich.edu/wp-content/uploads/2017/09/logo2-1.png",
...
const csl = {
    ...
    logo_url: "https://aero.engin.umich.edu/wp-content/uploads/sites/2/2021/05/CoE-AERO-header.svg",
    duration: "January 2019 - June 2019",
    location: "Office 100%",
    description: "Designed a high-strength fixture in Fusion 360 to withstand 100kip forces while maximizing turnaround times between experiments to allow characterization of laminate angles in composite sandwiched fearing. Employed digital image correlation techniques to characterize composite performance during stress testing campaigns. Quantified macro-cracks within ply's in specimens to their peak loads correlating the effects of macro-cracks of the yield strength of carbon-fiber composites"
};
...
const aerospaceDay = {
    ...
    logo_url: "https://brand.umich.edu/assets/brand/style-guide/logo-guidelines/U-M_Logo-Hex.png",
    duration: "March 2019",
    location: "Ann Arbor, Michigan",
    description: "Aerospace Day is an outreach that occurs every semester at the University of Michigan, where we showcase what the engineering students are working on and engage with the community.",
};

function ExperienceAccordion() {
    return (
        <div class="flex justify-center bg-primary-50 dark:bg-primary-900">
            <Accordion collapseAll className="w-3/4 self-center outline bg-primary-50 dark:bg-primary-900">
