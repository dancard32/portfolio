...
const favorite_tech = ['SiDocker', 'SiKubernetes', 'SiAnsible', 'SiHelm', 'SiGithub', 'SiGitlab', 'SiRaspberrypi', 'SiUbuntu', 'TbBrandVscode', 'SiPython', 'SiReact']
const looking_to_learn = ['SiGodotengine', 'FaAws', 'SiAmazonalexa', 'SiJavascript', 'FaJava']
    ...
    <div id="skills">
      ...
      <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        <div class="mr-auto place-self-center lg:col-span-4">
          ...
          {favorite_tech.map((icon) => {
              return <Icon nameIcon={icon} propsIcon={{ size: 50 }} />
            })}
          </div>
          <p class="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400 text-left">
            <Fade left duration={1000}>
              ...
              <br />
              🎮 End of year goal to develop a small indie game with GoDot
              <br />
      ...
      <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        ...
        <div class="mr-auto place-self-center lg:col-span-5">
          ...
          <p class="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400 text-left">
            <Fade right duration={1000}>
              🚀 Former lead tooling maintenance on a multi-billion dollar DoD
              contract
              <br />
      ...
      <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        <div class="mr-auto place-self-center lg:col-span-5">
          ...
          <div class="flex flex-wrap w-full justify-center">
          {looking_to_learn.map((icon) => {
              return <Icon nameIcon={icon} propsIcon={{ size: 50 }} />
            })}
          </div>
          <p class="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400 text-left">
            <Fade left duration={1000}>
              👨🏽‍💻 Always trying to improve! Above are languages/software I plan
              to learn
              <br />
              🧑‍🎓 Expected Georgia Tech graduation in Fall 2025
              <br />
              📧 Feel free to reach out to me with any technical questions or
              recommendations!
            </Fade>
          </p>
        </div>
